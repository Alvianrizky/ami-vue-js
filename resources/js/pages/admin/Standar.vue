    ...
    <div>
        <div class="content-header mx-1">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Standar Nasional</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Data Standar Nasional</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Data Standar Nasional</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <a href="#" class="btn btn-primary mt-2" @click.prevent="modalAdd()">
                                            <span class="fa fa-plus"></span> Tambah Data Standar Nasional
                                        </a>
                                    </div>
                                    <div class="col-4">
                                            ...
                                            <v-data-table :headers="headers" :items="rows" :options.sync="options"
                                                ...
                                                <template v-slot:item.actions="{ item }">
                                                    ...
                                                    <v-btn color="bg-danger" dark fab small
                                                        @click="handledelete(item.kode_sn)">
                                                        <v-icon>
                                                            mdi-delete
                                                        </v-icon>
                                                    </v-btn>
            ...
            <div class="modal-dialog text-dark">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Standar Nasional</h5>
                    ...
                    <form @submit.prevent="handlesubmit">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" required v-model="form.kode_sn">
                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Nama Standar</label>
                                <input type="text" class="form-control" required v-model="form.nama_sn">
                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Tanggal Standar</label>
                                <input type="date" class="form-control" required v-model="form.tanggal_sn">
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="handleUpdate">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label  class="form-label">Kode Standar</label>
                                <input type="text" class="form-control" required v-model="form.kode_sn" disabled>
                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Nama Standar</label>
                                <input type="text" class="form-control" required v-model="form.nama_sn">
...
<script>
    export default {
        ...
        methods: {
            ...
            handlesubmit() {
                axios.post('/api/admin/standar', this.form).then((response) => {
            ...
            handleUpdate() {
                ...
                axios.put('/api/admin/standar/'+this.form.kode_sn, this.form).then((response) => {
                    if (response.data.status) {
                        this.$swal.fire({
                            toast: true,
                            icon: 'success',
            ...
            handledelete(id) {
                this.$swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete('/api/admin/standar/' +id).then((response) => {
                            if(response.data.status) {
                                this.$swal.fire({
                                    icon: 'success',
