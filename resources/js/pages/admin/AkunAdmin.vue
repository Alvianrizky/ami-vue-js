                    ...
                    <form @submit.prevent="handlesubmit">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="akses" required v-model="form.hak_akses = 'Admin'" readonly>
                            </div>
                            <div class="mb-3">
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="handleUpdate">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="akses" class="form-label">Hak Akses</label>
                                <select class="form-select" aria-label="Default select example" id="akses" required v-model="form.hak_akses" disabled>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.get('/api/admin/akun/admin').then((response) => {
                    // console.log(response)
