    ...
    <div>
        <div class="content-header mx-1">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Deskripsi Perkejaan</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Data Deskripsi Perkejaan</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Data Deskripsi Perkejaan</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <a href="#" class="btn btn-primary mt-2" @click.prevent="modalAdd()">
                                            <span class="fa fa-plus"></span> Tambah Data Deskripsi Perkejaan
                                        </a>
                                    </div>
                                    <div class="col-4">
                                            ...
                                            <v-data-table :headers="headers" :items="rows" :options.sync="options"
                                                ...
                                                <template v-slot:item.actions="{ item }">
                                                    ...
                                                    <v-btn color="bg-danger" dark fab small
                                                        @click="handledelete(item.kode_jobdesk)">
                                                        <v-icon>
                                                            mdi-delete
                                                        </v-icon>
                                                    </v-btn>
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="handlesubmit">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">Kode Job Desk</label>
                                <input type="text" class="form-control" required v-model="form.kode_jobdesk" disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" rows="7" v-model="form.fungsi"></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tanggal Penetapan</label>
                                <input type="date" class="form-control" required v-model="form.tgl_penetapan">
                            </div>
                        </div>
...
<script>
    export default {
        ...
        methods: {
            getDataMax() {
                axios.get('/api/ketua/job-desk/max').then((response) => {
                    console.log(response)
                    this.form.kode_jobdesk = response.data.max
                }).catch((error) => {
            ...
            getData() {
                axios.get('/api/ketua/job-desk').then((response) => {
                    console.log(response)
            ...
            handlesubmit() {
                axios.post('/api/ketua/job-desk', this.form).then((response) => {
            ...
            handleUpdate() {
                ...
                axios.put('/api/ketua/job-desk/'+this.form.kode_jobdesk, this.form).then((response) => {
                    if (response.data.status) {
                        this.$swal.fire({
                            toast: true,
                            icon: 'success',
            ...
            handledelete(id) {
                this.$swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete('/api/ketua/job-desk/' +id).then((response) => {
                            if(response.data.status) {
                                this.$swal.fire({
                                    icon: 'success',
